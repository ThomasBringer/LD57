...
@onready var eye1: Sprite2D = $"../Visuals/Z/HeadTop/CircleHeadMask/Eye1Visual"
@onready var eye2: Sprite2D = $"../Visuals/Z/HeadTop/CircleHeadMask/Eye2Visual"

@onready var circle_head_mask: Sprite2D = $"../Visuals/Z/HeadTop/CircleHeadMask"
